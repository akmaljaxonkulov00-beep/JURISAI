    ...
    <div className="space-y-6">
      ...
      {error && (
        <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-800 flex items-center gap-2 text-sm text-red-700 dark:text-red-300">
          ...
          <button
            onClick={fetchData}
            className="ml-auto px-3 py-1 bg-red-600 text-white rounded-lg text-xs"
          >
            Qayta
          </button>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`p-2.5 rounded-lg bg-gradient-to-br ${CODE_COLORS[codeId] || 'from-blue-500 to-blue-600'} text-white`}
                  >
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 text-gray-500 hover:text-gray-700 dark:hover:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition-colors"
              >
                <ArrowLeft className="w-4 h-4" />
              </button>
              <div
                className={`p-2 rounded-lg bg-gradient-to-br ${CODE_COLORS[selectedCode] || 'from-blue-500 to-blue-600'} text-white`}
              >
                {CODE_ICONS[selectedCode] || <BookOpen className="w-4 h-4" />}
              </div>
              <div>
                <h3 className="font-semibold text-sm text-gray-800 dark:text-zinc-100">
                  {CODE_DISPLAY_NAMES[selectedCode] || selectedCode}
                </h3>
                <p className="text-xs text-gray-500 dark:text-zinc-400">
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-3 py-1.5 text-xs rounded-lg border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-700 dark:text-zinc-300 w-40"
                />
              </div>
              <Button
                size="sm"
      ...
      {showAddCategory && (
        ...
        >
          <div
            className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-xl max-w-md w-full border border-gray-200 dark:border-zinc-700"
          ...
          >
            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  value={newCategory.code_id}
                  onChange={e => setNewCategory(p => ({ ...p, code_id: e.target.value }))}
              ...
              <div className="flex gap-2 justify-end pt-2">
                <button
                  onClick={() => setShowAddCategory(false)}
                  className="px-4 py-2 text-sm text-gray-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg"
                >
                  Bekor
                </button>
                <button
                  onClick={addCategory}
                  disabled={saving || !newCategory.code_id || !newCategory.name}
      ...
      {showAddArticle && (
        ...
        >
          <div
            className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-xl max-w-2xl w-full border border-gray-200 dark:border-zinc-700 max-h-[85vh] overflow-y-auto"
            onClick={e => e.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    value={articleForm.code_id}
                    onChange={e => setArticleForm(p => ({ ...p, code_id: e.target.value }))}
                    className="w-full px-3 py-2 bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg text-sm text-gray-800 dark:text-zinc-200"
              ...
              <div>
                ...
                <Input
                  value={articleForm.chapter}
                  onChange={e => setArticleForm(p => ({ ...p, chapter: e.target.value }))}
              ...
              <div>
                ...
                <Input
                  value={articleForm.penalties}
                  onChange={e => setArticleForm(p => ({ ...p, penalties: e.target.value }))}
              ...
              <div className="flex gap-2 justify-end pt-2">
                ...
                <button
                  onClick={saveArticle}
                  disabled={saving || !articleForm.code_id || !articleForm.article_number}
                  className="px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center gap-1"
                >
                  {saving && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
