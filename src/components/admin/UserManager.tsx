      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-zinc-400">
            Foydalanuvchilarni boshqarish va obunalarni nazorat qilish
          </p>
        </div>
                      ...
                      <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-lg p-3 mb-3">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-sm text-gray-600 dark:text-zinc-400">
                            {user.subscription.subscription_plans.price}{' '}
                            {user.subscription.subscription_plans.currency}/oy
                          </div>
                        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setSubscriptionForm({ ...subscriptionForm, plan_id: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setSubscriptionForm({ ...subscriptionForm, status: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <option value="ACTIVE">Faol</option>
