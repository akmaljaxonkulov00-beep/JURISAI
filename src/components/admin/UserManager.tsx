  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-zinc-200">Foydalanuvchilar Boshqaruvi</h2>
          <p className="text-gray-600 dark:text-zinc-400">Foydalanuvchilarni boshqarish va obunalarni nazorat qilish</p>
        </div>
        <Button
          onClick={loadData}
          ...
          <div className="space-y-4">
            ...
            {filteredUsers.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 dark:text-zinc-400">Foydalanuvchilar topilmadi</p>
              </div>
            )}
          </div>
        </CardContent>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-md w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-gray-800 dark:text-zinc-200">Foydalanuvchini Tahrirlash</h3>
                <Button
                  variant="outline"
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    disabled
                    className="bg-gray-100 dark:bg-zinc-800/30"
                  />
                </div>
      ...
      {showSubscriptionModal && selectedUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-md w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-gray-800 dark:text-zinc-200">Obunani Boshqarish</h3>
                <Button
                  variant="outline"
