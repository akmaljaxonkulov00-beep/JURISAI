    ...
    <header className="bg-white dark:bg-zinc-900 px-4 sm:px-6 lg:px-8 py-4 border-b border-gray-100 dark:border-zinc-800">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex-shrink-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-zinc-100">{title}</h1>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
          ...
          <div className="flex items-center justify-end gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2">
              ...
              <span className="hidden sm:inline font-medium text-gray-800 dark:text-zinc-100">Sarvar K.</span>
            </div>
          </div>
        </div>
      </div>
