...
export default function AchievementSystem() {
  const [activeTab, setActiveTab] = useState<
    'achievements' | 'progress' | 'leaderboard' | 'rewards'
  >('achievements')
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      default:
        return <Award className="w-5 h-5 text-gray-600 dark:text-zinc-400" />
    }
  }
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-zinc-400">
          Gamifikatsiya orqali o'qish va rivojlanish
        </p>
      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        {achievement.requirements.map((req, index) => (
                          <div
                            key={index}
                            className="text-xs text-gray-600 dark:text-zinc-400 flex items-center space-x-1"
                          >
                            <div
                      ...
                      {achievement.rewards.badge && (
                        <div className="text-xs text-purple-600">★ {achievement.rewards.badge}</div>
                      )}
                    </div>
                  </div>
                </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {userStats.badges.map((badge, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-zinc-800/50 rounded-lg"
                  >
