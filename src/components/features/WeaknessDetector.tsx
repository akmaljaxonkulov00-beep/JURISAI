  ...
  const parseWeaknessResponse = (
    ...
    lines.forEach(line => {
      ...
      if (lower.includes('zaif') || lower.includes('weakness') || lower.includes('muammo')) {
        ...
        lower.includes('kuchli') ||
        lower.includes('strength') ||
        lower.includes('ijobiy')
      ) {
        currentSection = 'strength'
      } else if (
        lower.includes('tavsiya') ||
        lower.includes('recommendation') ||
        lower.includes('yaxshilash')
      ) {
    ...
    return {
      ...
      improvement_suggestions:
        suggestions.length > 0 ? suggestions : ['Argument ustida ishlashda davom eting'],
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                      ...
                      <p className="text-sm text-blue-700">
                        Qonun hujjatlariga asoslangan argumentlar
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
                      ...
                      <p className="text-sm text-green-700">
                        Dalillar va faktlarga asoslangan argumentlar
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                      ...
                      <p className="text-sm text-purple-700">
                        Mantiqiy izchillikka ega argumentlar
                      </p>
                    </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-zinc-400 mt-2">
                          {getArgumentTypeIcon(currentDetection.argument_type)}{' '}
                          {currentDetection.argument_type} argument
                        </p>
                      </div>
                      <div className="text-right">
                        <div
                          className={`text-3xl font-bold ${getScoreColor(currentDetection.overall_score)}`}
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                    <CardContent className="text-center p-6">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(currentDetection.legal_compliance_score)}`}
                      >
                  ...
                  <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                    <CardContent className="text-center p-6">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(currentDetection.logical_coherence_score)}`}
                      >
                  ...
                  <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                    <CardContent className="text-center p-6">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(currentDetection.factual_accuracy_score)}`}
                      >
                  ...
                  <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                    <CardContent className="text-center p-6">
                      <div
                        className={`text-2xl font-bold ${getScoreColor(currentDetection.persuasive_power_score)}`}
                      >
                  ...
                  <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                    <CardContent className="space-y-3 p-6">
                      {currentDetection.improvement_suggestions.map((suggestion, index) => (
                        <div
                          key={index}
                          className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200"
                        >
                    ...
                    <div className="flex flex-row items-center justify-between">
                      ...
                      <Badge
                        className={getSeverityColor(
                          detection.overall_score < 0.6
                            ? 'high'
                            : detection.overall_score < 0.8
                              ? 'medium'
                              : 'low'
                        )}
                      >
