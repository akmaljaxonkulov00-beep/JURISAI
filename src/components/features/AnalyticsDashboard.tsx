...
export default function AnalyticsDashboard() {
  const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'revenue' | 'ai' | 'documents'>(
    'overview'
  )
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-zinc-400">
          Platforma statistikasi va foydalanuvchi analitikasi
        </p>
      </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-red-600">
                  {analyticsData?.subscriptions.churn_rate}%
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-zinc-400">Bepul</span>
                <span className="font-semibold">
                  {analyticsData?.subscriptions.free.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-zinc-400">Pro</span>
                <span className="font-semibold">
                  {analyticsData?.subscriptions.pro.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-zinc-400">Premium</span>
                <span className="font-semibold">
                  {analyticsData?.subscriptions.premium.toLocaleString()}
                </span>
              </div>
            </div>
          </CardContent>
