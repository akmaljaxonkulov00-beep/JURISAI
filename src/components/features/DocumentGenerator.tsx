      ...
      return (
        <Card className="card-default rounded-2xl">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 dark:text-zinc-500 mb-6">
            ...
            <div className="flex gap-4">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Plus className="w-4 h-4 mr-2" /> Hujjatni yaratish
                  </>
                )}
              </Button>
              <Button
          ...
          <div className="space-y-4">
            {generatedDocuments.map(document => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-zinc-500">
                      {new Date(document.created_at).toLocaleDateString('uz-UZ')}
                    </p>
                  </div>
                  <Badge
                    className={
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-zinc-500 line-clamp-2">
            ...
            {generatedDocuments.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 dark:text-zinc-500">
                  Hali hech qanday hujjat yaratilmagan
                </p>
              </div>
            )}
          </div>
        ...
        <Card className="card-default rounded-2xl">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-400 dark:text-gray-500 dark:text-zinc-500">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-zinc-500">
              Huquqiy hujjatlar avtomatik generatsiyasi
            </p>
          </div>
        </div>
