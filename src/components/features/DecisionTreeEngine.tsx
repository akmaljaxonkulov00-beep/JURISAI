    ...
    >
      <CardHeader>
        <div className="flex justify-between items-start">
          ...
          <Badge className={getRiskColor(node.risk_level)}>{node.risk_level}</Badge>
        </div>
      </CardHeader>
      <CardContent>
        ...
        <div className="space-y-2">
          ...
          {node.options.map(option => (
            <div
              key={option.id}
              className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200"
            >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                      ...
                      <p className="text-sm text-purple-700">
                        Ishchi va ish beruvchi munosabatlari
                      </p>
                    </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        <CardTitle className="text-blue-900">
                          {currentTree.scenario_title}
                        </CardTitle>
                        <p className="text-gray-600 dark:text-zinc-400 mt-1">
                          {currentTree.scenario_description}
                        </p>
                      </div>
                      <div className="text-right">
                        <div
                          className={`text-2xl font-bold ${getConfidenceColor(currentTree.confidence_score)}`}
                        >
              ...
              <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                <CardContent className="text-center py-12">
                  <p className="text-gray-500 dark:text-zinc-500 mb-4">
                    Hali hech qanday qaror daraxti yaratilmagan
                  </p>
                  <Button
                ...
                >
                  <CardHeader>
                    <div className="flex flex-row items-center justify-between">
                      <CardTitle className="text-blue-900 text-lg">{tree.scenario_title}</CardTitle>
              ...
              {trees.length === 0 && (
                <div className="col-span-full">
                  <Card className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl">
                    <CardContent className="text-center py-12">
                      <p className="text-gray-500 dark:text-zinc-500 mb-4">
                        Hali hech qanday qaror daraxtlari mavjud emas
                      </p>
                      <Button
                        onClick={() => setActiveTab('create')}
                        className="bg-blue-600 hover:bg-blue-700"
