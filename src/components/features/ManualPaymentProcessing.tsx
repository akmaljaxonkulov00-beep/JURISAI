...
export default function ManualPaymentProcessing() {
  const [activeTab, setActiveTab] = useState<'plans' | 'request' | 'history' | 'instructions'>(
    'plans'
  )
  ...
  const handlePaymentRequest = async () => {
    ...
    try {
      ...
      const trackingNumber = `TRK${new Date().toISOString().slice(0, 10).replace(/-/g, '')}${Math.floor(
        Math.random() * 1000
      )
        .toString()
        .padStart(3, '0')}`
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mt-4 pt-4 border-t">
                        <p className="text-gray-600 dark:text-zinc-400 text-sm mb-1">
                          Foydalanuvchi ma'lumotlari:
                        </p>
                        <div className="flex items-center space-x-4 text-sm">
                          <span>
                            <strong>Ism:</strong> {request.userInfo.name}
                          </span>
                          <span>
                            <strong>Email:</strong> {request.userInfo.email}
                          </span>
                          <span>
                            <strong>Telefon:</strong> {request.userInfo.phone}
                          </span>
                          {request.userInfo.company && (
                            <span>
                              <strong>Kompaniya:</strong> {request.userInfo.company}
                            </span>
                          )}
                        </div>
                      </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400">
                    O'zingizga mos keladigan rejalardan birini tanlang. Har bir reja turlicha
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400">
                    Shaxsiy ma'lumotlaringizni to'ldiring va to'lov usulini tanlang. So'rov
                    yuborilgandan so'ng tracking raqami beriladi.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400">
                    Ko'rsatilgan bank hisob raqamiga to'lovni amalga oshiring. To'lov izohida
                    tracking raqamini ko'rsating.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400">
                    To'lov qilinganidan so'ng screenshot yoki chek rasmini support@jurisai.uz ga
                    yuboring.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400">
                    To'lov tasdiqlangandan so'ng 1-3 ish kuni ichida hisobingiz faollashtiriladi va
                    sizga email yuboriladi.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400 text-sm mb-2">
                    Bevosita bank hisob raqamiga pul o'tkazish
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400 text-sm mb-2">
                    Ofisimizda naqd pul bilan to'lov
                  </p>
                  <ul className="text-sm text-gray-600 dark:text-zinc-400 space-y-1">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400 text-sm">
                    Odatda 1-3 ish kuni ichida, lekin ba'zan 5 ish kungacha cho'zilishi mumkin.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400 text-sm">
                    Xizmat ko'rsatilmagan taqdirda 14 kun ichida to'lovni qaytarish mumkin.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-zinc-400 text-sm">
                    Support jamoasiga +998 90 123 45 67 raqami yoki support@jurisai.uz emaili orqali
                    murojaat qiling.
                  </p>
                </div>
              </div>
