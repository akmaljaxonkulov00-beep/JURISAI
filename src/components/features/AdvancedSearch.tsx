...
export default function AdvancedSearch() {
  const [activeTab, setActiveTab] = useState<'search' | 'history' | 'bookmarks' | 'trending'>(
    'search'
  )
      ...
      const mockResults: SearchResult[] = [
        {
          ...
          content:
            'Fuqarolik kodeksi - fuqarolik-huquqiy munosabatlarini tartibga soluvchi asosiy qonun hujjati. U 1-iyul 1996-yildan kuchga kirgan. Kodeks fuqarolarning huquq va majburiyatlarini, shartnomalar, mulk huquqi, meros huquqi kabi masalalarni tartibga soladi.',
          category: 'civil',
          documentType: 'code',
          ...
          highlights: [
            '<mark>Fuqarolik kodeksi</mark>',
            '<mark>fuqarolik-huquqiy munosabatlar</mark>',
            'tartibga soluvchi',
          ],
        },
        {
          ...
          content:
            "Shartnoma - tomonlarning o'zaro kelishuvi asosida vujudga keladigan huquqiy munosabat. Fuqarolik kodeksiga ko'ra, shartnoma tomonlarning o'zaro xohish-irodasi bilan tuziladi.",
          category: 'civil',
        ...
        },
        {
          ...
          content:
            "Da'vo muddati - sudga murojaat qilish uchun belgilangan vaqt. Fuqarolik kodeksiga ko'ra, da'vo muddati qonunda belgilangan muddatlarda qo'llaniladi.",
          category: 'civil',
          documentType: 'article',
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      default:
        return <Database className="w-4 h-4 text-gray-600 dark:text-zinc-400" />
    }
  }
              ...
              <div className="mt-4 flex flex-wrap gap-4">
                ...
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={e =>
                      setFilters(prev => ({ ...prev, isBookmarked: e.target.checked }))
                    }
                    className="w-4 h-4 text-blue-600 rounded"
                  />
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between text-sm text-gray-500 dark:text-zinc-500">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              <Bookmark
                                className={`w-4 h-4 ${result.isBookmarked ? 'fill-current text-blue-600' : ''}`}
                              />
                            </Button>
                            <Button
                              variant="ghost"
                ...
                <Card key={result.id} className="hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => handleBookmark(result.id)}>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-zinc-400">
                        {Math.floor(Math.random() * 1000 + 100)} marta qidirilgan
                      </p>
                    </div>
                  </div>
                  <Button
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <Bookmark
                        className={`w-4 h-4 ${selectedResult.isBookmarked ? 'fill-current text-blue-600' : ''}`}
                      />
                    </Button>
                    <Button
                      variant="outline"
