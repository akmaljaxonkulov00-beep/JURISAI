  ...
  const templates: DocumentTemplate[] = [
    {
      ...
      fields: [
        ...
        {
          name: 'sellerPassport',
          label: 'Sotuvchi pasport seriyasi va raqami',
          type: 'text',
          required: true,
        },
        {
          name: 'buyerPassport',
          label: 'Haridor pasport seriyasi va raqami',
          type: 'text',
          required: true,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: 'plaintiffPassport',
          label: "Da'vogar pasport seriyasi va raqami",
          type: 'text',
          required: true,
        },
        {
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'agent', label: 'Vakolat oluvchi F.I.O', type: 'text', required: true },
        {
          ...
          label: 'Vakolat beruvchi pasport seriyasi va raqami',
          type: 'text',
          required: true,
        },
        {
          name: 'agentPassport',
          label: 'Vakolat oluvchi pasport seriyasi va raqami',
          type: 'text',
          required: true,
        },
        {
          ...
          type: 'select',
          required: true,
          options: ["To'liq vakolat", 'Huquqiy maslahat', 'Sud ishlari', 'Mulk operatsiyalari'],
        },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'receiver', label: 'Qabul qiluvchi F.I.O', type: 'text', required: true },
        {
          ...
          label: 'Qabul qiluvchi pasport seriyasi va raqami',
          type: 'text',
          required: true,
        },
        { name: 'amount', label: "Summa (so'm)", type: 'number', required: true },
