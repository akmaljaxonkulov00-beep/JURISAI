...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ className, initialMessages = [] }) => {
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Badge variant={getModelBadge(selectedModel)}>{getModelName(selectedModel)}</Badge>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {isLoading && (
            <div className="flex items-start space-x-3">
              <Avatar fallback="AI" size="sm" className="bg-emerald-500 flex-shrink-0" />
