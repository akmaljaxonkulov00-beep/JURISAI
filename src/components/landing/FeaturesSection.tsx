  ...
  const features = [
    {
      ...
      title: 'IRAC Tahlili',
      description:
        'Xalqaro standartdagi IRAC metodologiyasi bilan huquqiy ishlarni chuqur tahlil qiling',
      icon: (
      ...
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6-3 6h-5.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"
          />
        </svg>
      ),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-zinc-400 max-w-3xl mx-auto">
            Zamonaviy AI va interaktiv vositalar bilan huquqiy bilimlaringizni yangi bosqichga
            ko'taring
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Barcha funksiyalarni cheklab ko'ring va qanday qilib professional huquqshunosga
              aylanishingizni ko'ring
            </p>
