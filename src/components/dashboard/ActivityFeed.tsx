...
const ActivityFeed: React.FC<ActivityFeedProps> = ({ activities, maxItems = 10, className }) => {
            ...
            displayActivities.map(activity => (
              <div key={activity.id} className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 dark:text-zinc-400 mt-1">{activity.action}</p>
                  {activity.details && (
