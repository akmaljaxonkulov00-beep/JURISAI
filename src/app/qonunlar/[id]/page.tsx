...
import {
  ...
  ExternalLink, AlertCircle, Sparkles, Loader2, X, ChevronDown
} from 'lucide-react';
...
export default function CodeDetailPage() {
  ...
  const handleAiExplain = async (article: LegalArticle, cId: string) => {
    ...
    try {
      ...
      setExplainResult('Kechirasiz, AI izohni yuklashda xatolik yuz berdi. Iltimos, qayta urinib ko\'ring.');
    } finally {
              ...
              {explainingArticle?.number === selectedArticle.number && explainResult && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800">
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">AI izohi</span>
                    <button
                ...
                <CardContent className="pt-3">
                          ...
                          <div className="mt-2 pl-3 border-l-2 border-purple-300 dark:border-purple-700">
                            {explainLoading ? (
                              <div className="flex items-center gap-2 py-2">
                                ...
                                <span className="text-xs text-purple-600 dark:text-purple-400">AI izohi yuklanmoqda...</span>
                              </div>
                            ) : explainResult ? (
                  ...
                  {hasMore && (
                    ...
                    >
                      ...
                      Yana {Math.min(articles.length - visibleCount, ARTICLES_PER_PAGE)} ta ko'rsatish ({articles.length - visibleCount} ta qoldi)
                    </button>
                  )}
                </CardContent>
              </Card>
