...
export async function GET(request: NextRequest) {
  try {
    ...
    const mockCases = [
      {
        ...
        description:
          "Ikki kompaniya o'rtasida shartnoma shartlarining buzilishi munosabati bilan yuzaga kelgan nizo",
      ...
      },
      {
        ...
        description:
          "Xodimning ish haqi vaqtni to'lanmaganligi munosabati bilan ish beruvchiga qarshi da'vo",
    ...
    return NextResponse.json({ error: 'Sud ishlarini olishda xatolik yuz berdi' }, { status: 500 })
  }
}
