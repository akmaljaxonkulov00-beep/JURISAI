...
export async function POST(request: NextRequest) {
  try {
    const { argument_text, argument_type, context, target_audience, analysis_depth } =
      await request.json()
    ...
    const mockWeaknessAnalysis = {
      ...
      weakness_points: [
        {
          ...
          severity: 'medium',
          description:
            "Argumentda mantiqiy xatolik mavjud - sabab va oqibat o'rtasida to'g'ri bog'lanish yo'q",
          location: '3-5 qatorlar',
          example: "\"Shu sababli, bu xulosa to'g'ri\" - yetarli asos yo'q",
          improvement_suggestion:
            "Sabab va oqibat o'rtasida aniq bog'lanish o'rnating, qo'shimcha dalillar keltiring",
          confidence: 0.85,
        },
        {
          id: 'weak_2',
          ...
          improvement_suggestion:
            "Qonun hujjatlari, statistik ma'lumotlar yoki ekspert xulosalarini keltiring",
          confidence: 0.92,
        },
        {
          id: 'weak_3',
          ...
          improvement_suggestion:
            "Hissiy ifodalarni qisqartiring, o'rniga rasmiy dalillarga e'tibor bering",
          confidence: 0.78,
        },
      ],
      strength_points: [
      ...
      detailed_analysis: {
        logical_coherence: {
          ...
          issues: ["Sabab-oqibat bog'lanishining yetishmasligi", 'Xulosa chiqarishda xatoliklar'],
          recommendations: [
        ...
        argument_structure: {
          ...
          strengths: ['Aniq kirish qismi', 'Mantiqiy ketma-ketlik', 'Xulosa qismi mavjud'],
          recommendations: [
        ...
        persuasiveness: {
          ...
          issues: ["Hissiy ifodalar ko'p", 'Rasmiy uslubda emas'],
          recommendations: [
