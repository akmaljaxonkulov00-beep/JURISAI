...
export async function GET(request: NextRequest) {
  try {
    ...
    const mockAnalyses = [
      {
        id: 'analysis_1',
        argument_text:
          "Mazkur shartnoma buzilgani uchun tovon to'lash talab qilinadi. Bu aniq adolatsizlik va to'g'ri emas.",
        argument_type: 'legal',
      ...
      },
      {
        id: 'analysis_2',
        argument_text:
          "Ish haqi 3 oy davomida to'lanmaganligi sababli, kompensatsiya talab qilinadi. Mehnat kodeksiga ko'ra, bu majburiyatni buzish hisoblanadi.",
        argument_type: 'labor',
        ...
        status: 'completed',
        improvement_suggestions: ["Hisoblash jadvalini qo'shing", "Qo'shimcha dalillar keltiring"],
        tags: ['hisoblash', 'dalillar', 'mehnat huquqi'],
      },
      {
        id: 'analysis_3',
        argument_text:
          "Oilaviy mulk bo'linishi munosabati bilan farzandlar manfaati birinchi o'rinda turishi kerak. Vosa huquqi asosida, onaning farzandlarni o'zi bilan qolishi ma'qul.",
      ...
      },
      {
        id: 'analysis_4',
        argument_text:
          "Ayblanuvchi tomonidan o'g'irlik sodir etilgani isbotlangan. Jinoyat kodeksining 169-moddasiga ko'ra, bu og'ir jinoyat hisoblanadi.",
      ...
      },
      {
        id: 'analysis_5',
        argument_text:
          "Ijaraga olingan uyning holati yomonlashgani sababli, ijara to'lovini kamaytirish talab qilinadi. Shartnomaning 8-bandiga ko'ra, ijara beruvchi mulk holatini saqlashi lozim.",
      ...
      },
      {
        id: 'analysis_6',
        argument_text:
          "Qarz shartnomasiga ko'ra, qarzni 2024 yil 1-martgacha qaytarish kerak edi. Muddatning o'tishi sababli, kechikish uchun foizlar hisoblanadi.",
        ...
        status: 'completed',
        improvement_suggestions: ['Foizlar miqdorini hisoblang', "Qonuniy asoslarni ko'rsating"],
        tags: ['qarz', 'foizlar', 'muddatlar'],
      },
      {
        id: 'analysis_7',
        argument_text:
          'Mualliflik huquqlarini buzish holati aniqlangan. Asar muallifning ruxsatisiz foydalanilgan, bu intellektual mulk huquqining buzilishidir.',
      ...
      },
      {
        id: 'analysis_8',
        argument_text:
          "Transport vositasi yo'l-transport hodisasi natijasida shikastlangan. Suvayib haydovchining to'liq javobgarligi belgilanishi kerak.",
    ...
    return NextResponse.json({
      ...
      summary: {
        ...
        average_score: Math.round(
          filteredAnalyses.reduce((sum, a) => sum + a.overall_score, 0) / filteredAnalyses.length
        ),
        average_confidence: Math.round(
          filteredAnalyses.reduce((sum, a) => sum + a.confidence_level, 0) / filteredAnalyses.length
        ),
        by_argument_type: {
          ...
          other: filteredAnalyses.filter(
            a => !['legal', 'labor', 'family', 'criminal', 'property'].includes(a.argument_type)
          ).length,
        },
        by_score_range: {
    ...
    return NextResponse.json({ error: 'Tahlillarni olishda xatolik yuz berdi' }, { status: 500 })
  }
}
