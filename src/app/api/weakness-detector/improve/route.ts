...
export async function POST(request: NextRequest) {
  try {
    ...
    const mockImprovement = {
      ...
      improved_argument: generateImprovedArgument(
        original_argument,
        weakness_points,
        improvement_style
      ),
      ...
      detailed_changes: {
        ...
        content_additions: [
          ...
          },
          {
            ...
            added:
              "2023 yil statistikasiga ko'ra, shunday nizolarning 65% da da'vogar g'alaba qozongan",
      ...
      comparison_analysis: {
        ...
        overall_assessment:
          'Argument sifati sezilarli darajada yaxshilandi, xatoliklar bartaraf etildi',
      },
      recommendations: [
        {
